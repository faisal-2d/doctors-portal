    ...
    <div className="card lg:max-h-lg bg-base-100 shadow-xl text-center">
      <div className="card-body">
        ...
        <div className="card-actions justify-center">            
          <label for="booking-modal" disabled={appointment.slots.length === 0} onClick={()=> setBooking(appointment)} className="btn btn-primary modal-button">Book Appointment</label>          
        </div>
      </div>
    </div>
  );
